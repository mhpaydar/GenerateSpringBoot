...
public class FileApiResponse {
    public static void gen(TableModel tableModel, String __PKGJAVAAPI) throws Exception {
        ...
        sbjavaResponse.append("public class " + tableModel.getClazzName() + "Response extends AbstractBasePortable<"+tableModel.getPkColumnType().getValue() +"> {\n\n");
...
//                        RunGenSpringDB.translate.putIfAbsent(d.getColNameJava(),d.getColNameJava());
                    } else {
                        String mapped = "";
                        ...
                        sbjavaResponse.append("\t@Schema(description = \"\", extensions = {@Extension(name = \"x-uix\", properties = {\n" +
                                ...
                                "\t\t, @ExtensionProperty(name = \"dependant\", value = \"\")\n" +
                                "\t\t})})\n");
                        sbjavaResponse.append("\tprivate " + parentTable.getClazzName() + "Response " + mapped + ";\n");
//                        RunGenSpringDB.translate.putIfAbsent(mapped,mapped);
        ...
        Files.write(Paths.get( dir+Constant.fileSep+ tableModel.getClazzName() + "Response.java"), lstjavaResponse);
